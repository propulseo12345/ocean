...
export const reportFr = {
  report: {
    ...
    actions: {
      ...
      copiedTitle: "Lien d'aperçu copié (aperçu)",
      copiedDescription: "En production : lien figé à jeton révocable, sans compte requis.",
      readyTitle: "Lien d'aperçu prêt (aperçu)",
