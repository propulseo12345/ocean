...
export const MARRONNIERS: Marronnier[] = [
  ...
  { date: "2026-01-06", label: loc("Épiphanie — galette des rois", "Epiphany — king cake"), kind: "fete" },
  { date: "2026-01-07", label: loc("Début des soldes d'hiver", "Winter sales begin"), kind: "soldes" },
  ...
  { date: "2026-03-08", label: loc("Journée internationale des droits des femmes", "International Women's Rights Day"), kind: "marketing" },
  { date: "2026-03-20", label: loc("Arrivée du printemps", "First day of spring"), kind: "marketing" },
  ...
  { date: "2026-06-05", label: loc("Journée mondiale de l'environnement", "World Environment Day"), kind: "marketing" },
  { date: "2026-06-08", label: loc("Journée mondiale de l'océan", "World Oceans Day"), kind: "marketing" },
  { date: "2026-06-13", label: loc("Journée mondiale du bien-être", "Global Wellness Day"), kind: "marketing" },
  ...
  { date: "2026-06-21", label: loc("Journée internationale du yoga", "International Yoga Day"), kind: "marketing" },
  { date: "2026-06-24", label: loc("Début des soldes d'été", "Summer sales begin"), kind: "soldes" },
  ...
  { date: "2026-10-01", label: loc("Journée internationale du café", "International Coffee Day"), kind: "marketing" },
  { date: "2026-10-12", label: loc("Semaine du goût (début)", "Taste Week (start)"), kind: "marketing" },
