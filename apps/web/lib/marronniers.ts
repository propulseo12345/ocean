...
export const MARRONNIER_KIND_LABELS: Record<MarronnierKind, string> = {
  ferie: "Jour férié",
  fete: "Fête",
  soldes: "Soldes",
...
export const MARRONNIERS: Marronnier[] = [
  ...
  { date: "2026-01-06", label: "Épiphanie — galette des rois", kind: "fete" },
  { date: "2026-01-07", label: "Début des soldes d'hiver", kind: "soldes" },
  ...
  { date: "2026-03-08", label: "Journée internationale des droits des femmes", kind: "marketing" },
  { date: "2026-03-20", label: "Arrivée du printemps", kind: "marketing" },
  ...
  { date: "2026-06-05", label: "Journée mondiale de l'environnement", kind: "marketing" },
  { date: "2026-06-08", label: "Journée mondiale de l'océan", kind: "marketing" },
  { date: "2026-06-13", label: "Journée mondiale du bien-être", kind: "marketing" },
  { date: "2026-06-21", label: "Fête de la musique", kind: "fete" },
  { date: "2026-06-21", label: "Fête des pères", kind: "fete" },
  { date: "2026-06-21", label: "Journée internationale du yoga", kind: "marketing" },
  { date: "2026-06-24", label: "Début des soldes d'été", kind: "soldes" },
  ...
  { date: "2026-10-01", label: "Journée internationale du café", kind: "marketing" },
  { date: "2026-10-12", label: "Semaine du goût (début)", kind: "marketing" },
