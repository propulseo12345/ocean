-- Migration 013 a appliquer sur hgdeopkmkwyoumsfggrm (SQL Editor).
-- Genere depuis supabase/migrations/013_collaboration.sql.
-- Prerequis : 010, 011, 012 appliquees (FK vers content_media, clients, etc.).
