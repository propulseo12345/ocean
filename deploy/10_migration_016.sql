-- Migration 016 a appliquer sur hgdeopkmkwyoumsfggrm (SQL Editor).
-- Genere depuis supabase/migrations/016_transitions.sql. Prerequis : 010-015.
--
-- Cette migration REMPLACE la fonction de garde de 008 (create or replace) et
-- ajoute deux RPC. Elle est rejouable telle quelle : aucun DDL de table.
