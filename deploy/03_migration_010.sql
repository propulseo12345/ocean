...
-- NB : ALTER TYPE ... ADD VALUE ne peut pas etre dans une transaction qui l'utilise ;
-- ce fichier ne l'utilise pas, mais on l'execute HORS begin/commit par prudence.
